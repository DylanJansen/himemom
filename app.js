...
const OwnerID = "509385145732825099";
...
Client.on("guildMemberAdd", member => {
   member.guild.defaultChannel.send("Welcome to: " + member.guild.name + " dfghh")
});
...
Client.login("NTA5Mzg1MTQ1NzMyODI1MDk5.DsNBoQ.Qwm4pUuqmQIgRAz8unz6hNU2lok");
